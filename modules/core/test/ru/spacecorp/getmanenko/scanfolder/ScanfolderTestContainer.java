...
public class ScanfolderTestContainer extends TestContainer {

    public ScanfolderTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/spacecorp/getmanenko/scanfolder/app.properties",
    ...
    public static class Common extends ScanfolderTestContainer {

        public static final ScanfolderTestContainer.Common INSTANCE = new ScanfolderTestContainer.Common();
